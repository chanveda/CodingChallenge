...
namespace ConstructionLine.CodingChallenge.Tests
{
    ...
    public class SearchEnginePerformanceTests : SearchEngineTestsBase
    {
        ...
        public void PerformanceTest()
        {
            ...
            // var results = _searchEngine.LookupSearch(options);


            sw.Stop();
            Console.WriteLine($"Test fixture finished in {sw.ElapsedMilliseconds} milliseconds");
            Console.WriteLine($"Lookup intialization finished in {results.Milliseconds} milliseconds");
            Console.WriteLine($"Search finished in {sw.ElapsedMilliseconds - results.Milliseconds} milliseconds");
